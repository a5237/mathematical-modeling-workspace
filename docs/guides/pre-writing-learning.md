...
2. 结构、摘要组织、篇幅分配与表达策略的学习必须使用**同赛事**范文：CUMCM 项目用 CUMCM 优秀论文，MCM/ICM 项目用 MCM/ICM 获奖论文（`resources/paper-library/` 美赛篇目或经核验的公开获奖论文）；跨赛事范文只可用于数学方法与论证逻辑学习，不得计入结构学习的范文数量。

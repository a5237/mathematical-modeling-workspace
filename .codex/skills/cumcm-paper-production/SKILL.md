...
3. Read `docs/standards/modeling-execution.md` and `resources/algorithm-library/index.md`, load only matching algorithm documents, and complete `WG-MODEL-001` before formal implementation.

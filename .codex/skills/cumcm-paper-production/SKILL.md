...
8. Maintain `WG-AI-001` and apply `OFFICIAL-CUMCM-001`.
...
- Run `scripts/init_cumcm_project.py` for the `LAYOUT-001` recommended skeleton and project copies of the shared templates.
...
- Read `docs/standards/cumcm-current-rules.md` when current format or AI disclosure is in scope.

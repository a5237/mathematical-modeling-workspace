...
1. Read the problem statement, `docs/standards/workspace-governance.md`, `docs/standards/paper-writing.md`, `docs/standards/paper-quality-audit.md`, project manifest, problem checklist, and paper.
...
7. Render the final delivery PDF page by page. Inspect page order, margins, overflow, figure/table captions, equation numbering, references, page count, and every figure's clarity and intuitiveness. Explicitly check for overlapping or clipped text, nodes, arrows, connectors, legends, labels, and ambiguous flowchart branches; source-file inspection is not sufficient.
...
11. Write or update `07-review/paper-quality-audit.md` using `docs/standards/paper-quality-audit.md`. Give two independent verdicts: `paper-writing.md` compliance and national-award competitiveness. Do not infer that compliance alone implies award competitiveness.
12. If any paper, figure, table, or pagination changes after review, invalidate the prior PDF hash, re-render the affected output, and refresh both verdicts before release.
